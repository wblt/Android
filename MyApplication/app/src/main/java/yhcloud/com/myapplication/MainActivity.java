package yhcloud.com.myapplication;
...
import yhcloud.com.myapplication.bean.Bean;
import yhcloud.com.myapplication.bean.FileBean;
import yhcloud.com.myapplication.tree.Node;
import yhcloud.com.myapplication.tree.TreeListViewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initDatas()
    {
        ...
        mDatas.add(new Bean(5, 3, "子目录1-1"));
