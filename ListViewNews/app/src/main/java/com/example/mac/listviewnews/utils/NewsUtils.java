package com.example.mac.listviewnews.utils;
...
public class NewsUtils {
    ...
    public static ArrayList<NewsBean> getAllNews(Context context) {
        ...
        for(int i = 0 ;i <100;i++)
        {
            ...
            newsBean.icon = R.mipmap.ic_launcher;//通过context对象将一个资源id转换成一个Drawable对象。
            ...
            newsBean1.icon = R.mipmap.ic_launcher;//通过context对象将一个资源id转换成一个Drawable对象。
            ...
            newsBean2.icon = R.mipmap.ic_launcher;//通过context对象将一个资源id转换成一个Drawable对象。
